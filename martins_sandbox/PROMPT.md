...
### 1
Implement the same task like in gaussian_process.py using random forest regressor in random_forest_regressor.py. My initial aims are described in PROMPT.md file
